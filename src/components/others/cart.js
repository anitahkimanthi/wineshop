  ...
  return (
    <div className='row cart' onClose={handleClose}>
      {cart.length !== 0 ? (
        ...
        <div className='col-12 text-center'>No items added</div>
      )}
            ...
            <div className='col-8 col-sm-5 col-md-7price_total'>
              <ul className='product_total altotal row'>
                <li className='list-unstyled price col-12 col-md-6'>
                  <h3>
                    <b>$ {(Math.round(totalPrice * 100) / 100).toFixed(2)}</b>
                  </h3>
                </li>
...
export default connect(mapStateToProps, { cartItemsCalculations, emptyCart })(
  Cart
)
